...
<head>
    ...
    <title>Cajas - Bancos | Software de Gestion | Luna Systems Peru</title>
        ...
        <div class="boxed">
            ...
            <div id="content-container">
                <div id="page-head">
                    ...
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <div id="page-title">
                        <h1 class="page-header text-overflow">Cajas - Bancos</h1>
                    </div>
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <!--End page title-->
					...
					<li class="active">Cajas - Bancos</li>
                    </ol>
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <!--End breadcrumb-->
                ...
                <div id="page-content">
					...
					<div class="panel">
					    <div class="panel-body">
					        <a href="reg_banco.php" id="demo-delete-row" class="btn btn-success" ><i class="fa fa-plus"></i> Agregar</a>
					        <table id="demo-custom-toolbar" class="demo-add-niftycheck"
                                   data-toggle="table"
					               data-url="../data/tables/bancos.php"
					            ...
					            <thead>
					                <tr>
					                    <th data-field="id_banco" data-sortable="true">ID</th>
					                    <th data-field="nombre" data-sortable="true">Nombre</th>
					                    <th data-field="nro_cuenta" data-align="center" data-sortable="true" >Nro Cuenta</th>
					                    <th data-field="monto" data-align="right" data-sortable="true" >Monto S/</th>
                                        <th data-field="id_banco" data-align="center" data-sortable="false" data-formatter="actionFormatter">Acciones</th>
					                </tr>
					            </thead>
					        </table>
					    </div>
    ...
    function actionFormatter(value, row) {
        if (value) {
            return '<a href="mod_prospecto.php?id_prospecto=' + value + '" class="btn btn-icon btn-info" title="Editar Producto"><i class="fa fa-edit"></i></a> ' +
                '<a href="ver_bancos_movimientos.php?id_banco=' + value + '" class="btn btn-icon btn-success" title="Ver Precios"><i class="fa fa-eye"></i></a>';
        }
    }
</script>
