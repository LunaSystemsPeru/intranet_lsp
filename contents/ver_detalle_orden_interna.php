...
require '../models/cl_orden_interna_venta.php';
                    ...
                    <div class="panel ">
                        ...
                        <div class="panel-heading">
                            <div class="col-lg-12">
                                ...
                                <a href="../controller" class="btn btn-warning"><i class="fa fa-check"></i> Aprobar Servicio</a>
...
<div class="modal fade" id="demo-default-modal" role="dialog" tabindex="-1" aria-labelledby="demo-default-modal" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form method="post" action="../controller/reg_orden_interna_venta.php">
                <!--Modal body-->
