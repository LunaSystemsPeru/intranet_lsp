...
<head>
    ...
    <title>Proveedor | Software de Gestion | Luna Systems Peru</title>
            ...
            <div id="page-content">
                ...
                <div class="panel">
                    <div class="panel-heading">
                        <h3 class="panel-title text-bold">Agregar Proveedor</h3>
                    </div>

                    <!--Horizontal Form-->
                    <!--===================================================-->
                    <form class="form-horizontal" method="POST" action="../controller/reg_proveedor.php">
                        <div class="panel-body">
                            <fieldset>
                                <div class="form-group">
                                    <label class="col-lg-2 control-label">Nro RUC:</label>
                                    <div class="col-lg-3">
                                        <input type="text" class="form-control" id="input_ruc" name="input_ruc" maxlength="11" required/>
                                    </div>
                                    <div class="col-lg-2">
                                        <button type=button class="btn btn-info btn-icon" id="btn_comprueba" onclick="validarDocumento()"><i class="fa fa-search"></i> Validar</button>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label class="col-lg-2 control-label">Producto / Servicio:</label>
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control" name="input_producto"/>
                                    </div>
                                </div>
                            </fieldset>
                        </div>
