                    ...
                    <div class="panel">
                        ...
                        <div class="panel-body">
                            ...
                            <table id="demo-custom-toolbar" class="demo-add-niftycheck"
                                   data-toggle="table"
                                   data-url="../data/tables/alquiler_pagos.php?id_alquiler=<?php echo $c_alquiler->getIdAlquiler() ?>"
...
<div class="modal fade" id="demo-default-modal" role="dialog" tabindex="-1" aria-labelledby="demo-default-modal" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form method="post" action="../controller/reg_alquiler_venta.php">
                <!--Modal body-->
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="input_monto" name="input_monto" class="form-control" value="<?php echo $c_alquiler->getMontoCuota()?>" >
                    </div>
                    <div class="form-group">
