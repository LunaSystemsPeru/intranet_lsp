...
<head>
    ...
    <title>Proveedores | Software de Gestion | Luna Systems Peru</title>
                ...
                <div id="page-content">
					...
					<div class="panel">
					    <div class="panel-body">
					        <a href="reg_proveedor.php" id="demo-delete-row" class="btn btn-danger" ><i class="demo-pli-cross"></i> Agregar</a>
					        <table id="demo-custom-toolbar" class="demo-add-niftycheck"
                                   data-toggle="table"
					               data-url="../data/tables/proveedor.php"
					            ...
					            <thead>
					                <tr>
					                    <th data-field="id_proveedor" data-sortable="true">ID</th>
					                    <th data-field="razon_social" data-sortable="true">Empresa</th>
					                    <th data-field="documento" data-sortable="true" >RUC / DNI</th>
                                        <th data-field="producto" data-sortable="true" >Producto / Servicio</th>
					                    <th data-field="total_compra" data-align="center" data-sortable="true" >S/ Compras</th>
                                        <th data-field="total_pagado" data-align="center" data-sortable="true" >S/ Pagos</th>
                                        <th data-field="id_proveedor" data-align="center" data-sortable="false" data-formatter="actionFormatter">Acciones</th>
					                </tr>
					            </thead>
					        </table>
					    </div>
    ...
    function actionFormatter(value, row) {
        if (value) {
            return '<a href="mod_prospecto.php?id_prospecto=' + value + '" class="btn btn-icon btn-info" title="Editar Prospecto"><i class="fa fa-edit"></i></a> ' +
                '<a href=' + value + '"ver_detalle_prospecto.php?id_prospecto=" class="btn btn-icon btn-success" title="Ver Historial del Prospecto"><i class="fa fa-eye"></i></a>';
        }
    }
</script>
