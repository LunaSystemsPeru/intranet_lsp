...
<head>
    ...
    <title>Contrato | Software de Gestion | Luna Systems Peru</title>
    ...
    <div class="boxed">
        ...
        <div id="content-container">
            <div id="page-head">
                ...
                <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                <div id="page-title">
                    <h1 class="page-header text-overflow">Contrato</h1>
                </div>
                <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                <!--End page title-->
            ...
            <div id="page-content">
                ...
                <div class="panel">
                    <div class="panel-heading">
                        <h3 class="panel-title text-bold">Agregar Contrato </h3>
                    </div>
                    ...
                    <form class="form-horizontal" method="POST" action="../controller/reg_contrato.php">
                        <div class="panel-body">
                            <fieldset>
                                ...
                                <div class="form-group">
                                    <label class="col-lg-2 control-label">Duracion</label>
                                    <div class="col-lg-2">
                                        <input type="number" class="form-control" name="input_duracion" value="30" required/>
                                    </div>
                                </div>
                                <div class="form-group">
