            ...
            <div id="page-content">
                ...
                <div class="panel">
                    <div class="panel-heading">
                        <h3 class="panel-title text-bold">Modificar Prospecto</h3>
                    </div>
                    ...
                    <form class="form-horizontal" method="POST" action="../controller/reg_prospecto.php">
                        <div class="panel-body">
                            ...
                            <fieldset>
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control" name="input_representante" value="<?php echo $c_prospecto->getDatos()?>" required/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-lg-2 control-label">E-mail</label>
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control" name="input_email" value="<?php echo $c_prospecto->getEmail()?>"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-lg-2 control-label">Telefono - Celular</label>
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control" name="input_celular" value="<?php echo $c_prospecto->getCelular()?>" required/>
                                    </div>
                                </div>
                            </fieldset>
                            ...
                            <fieldset>
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-3">
                                        <input type="text" class="form-control" id="input_ruc" name="input_ruc" value="<?php echo $c_prospecto->getRuc()?>"/>
                                    </div>
                                    <div class="col-lg-2">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control" id="input_razon_social" name="input_razon_social" value="<?php echo $c_prospecto->getRazonSocial()?>"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-lg-2 control-label">Nombre Comercial:</label>
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control" id="input_comercial" name="input_comercial" value="<?php echo $c_prospecto->getNombreComercial()?>" required/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-lg-2 control-label">Direccion Empresa:</label>
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control" id="input_direccion" name="input_direccion" value="<?php echo $c_prospecto->getDireccion()?>"/>
                                    </div>
                                </div>
                        ...
                        <div class="panel-footer text-right">
                            <input type="hidden" name="input_codigo" value="<?php echo $c_prospecto->getIdProspecto()?>">
