        ...
        <div class="navbar-header">
            <a href="index.html" class="navbar-brand">
                ...
                <div class="brand-title">
                    <span class="brand-text">Luna Systems</span>
                </div>
            </a>
        </div>
        <!--================================-->
                            ...
                            <div class="nano-content">
                                <ul class="head-list">
                                    ...
                                    <li>
                                        <a class="media" href="#">
                                            <div class="media-left">
                                                <img class="img-circle img-sm" alt="Profile Picture" src="../public/img/profile-photos/9.png">
                                            </div>
                                            <div class="media-body">
                                    ...
                                    <li>
                                        <a class="media" href="#">
                                            <div class="media-left">
                                                <img class="img-circle img-sm" alt="Profile Picture" src="../public/img/profile-photos/3.png">
                                            </div>
                                            <div class="media-body">
