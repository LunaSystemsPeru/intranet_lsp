...
class cl_prospecto_accesos
{
    ...
    {
        $query = "insert into prospectos_accesos values ('$this->id_acceso', '$this->nombre', '$this->url', '$this->usuario', 
        '$this->clave', '$this->id_prospecto')";
        return $this->c_conectar->ejecutar_idu($query);
    }

    public function obtener_id()
    {
        $sql = "select ifnull(max(id_acceso) + 1, 1) as codigo 
        from prospectos_accesos";
        $this->id_acceso = $this->c_conectar->get_valor_query($sql, "codigo");
    }
