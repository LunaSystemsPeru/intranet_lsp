...
class cl_prospecto
{
    ...
    {
        $query = "update prospectos set datos =  '$this->datos', celular = '$this->celular', email = '" . $this->email . "', 
        nombre_comercial = '" . $this->nombre_comercial . "', razon_social = '" . $this->razon_social . "', ruc = '" . $this->ruc . "', direccion = '" . $this->direccion . "'
