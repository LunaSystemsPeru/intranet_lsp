                                            ...
                                            <div class="col-xs-5">
                                                <div class="media">
                                                    <div class="media-left">
                                                        <span class="text-3x text-thin text-main">541.66</span>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-xs-7 text-sm">
                                                <p>
                                                    ...
                                                    <span class="pad-lft text-semibold">
					                                        <span class="text-lg">150.00</span>
                                                    </span>
                                                </p>
                                                <p>
                                                    <span>Ingreso Maximo</span>
                                                    <span class="pad-lft text-semibold">
					                                        <span class="text-lg">1500.00</span>
                                                    </span>
                                                </p>
                                            </div>
                                        </div>
                            ...
                            <div class="col-sm-6 col-lg-6">
                                ...
                                <div class="panel panel-info panel-colorful">
                                    <div class="pad-all">
                                        ...
                                        <p class="mar-no">
                                            <span class="pull-right text-bold" >780.00</span> total cobrar S/
                                        </p>
                                        <p class="mar-no">
                                            <span class="pull-right text-bold">0.00</span> total pagado S/
                                        </p>
                                    </div>
                                    <div class="pad-top text-center">
                            ...
                            <div class="col-sm-6 col-lg-6">
                                ...
                                <div class="panel panel-purple panel-colorful">
                                    <div class="pad-all">
                                        ...
                                        <p class="mar-no">
                                            <span class="pull-right text-bold">0.00</span> Total S/
                                        </p>
                                        <p class="mar-no">
                                            <span class="pull-right text-bold">0</span> Nro Documentos
                                        </p>
                                    </div>
                            ...
                            <div class="col-sm-6 col-lg-6">
                                ...
                                <div class="panel panel-warning panel-colorful">
                                    <div class="pad-all">
                                        ...
                                        <p class="mar-no">
                                            <span class="pull-right text-bold">259.00</span> Por Pagar S/
                                        </p>
                                    </div>
                                    <div class="pad-all">
                                        <div class="pad-btm">
