        ...
        <div id="content-container">
            ...
            <div id="page-content">
                ...
                <div class="panel">
                    ...
                    <!--Horizontal Form-->
                    <!--===================================================-->
                    <form class="form-horizontal" method="POST" action="procesos/reg_prospecto.php">
                        <div class="panel-body">
                            ...
                            <fieldset>
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-3">
                                        <input type="text" class="form-control" name="input_ruc"/>
                                    </div>
                                    <div class="col-lg-2">
                                        <button type=button class="btn btn-info btn-icon"><i class="fa fa-search"></i> Validar</button>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control" name="input_comercial" required/>
                                    </div>
                                </div>
                                <div class="form-group">
